...
const ganeshMiniHomeItems: SamagriItem[] = [
  ...
  { nameEn: "Clay lamps (Matti depalu)", nameTe: "మట్టి దీపాలు", quantity: 2 },
...
const ganeshMiniOfficeItems: SamagriItem[] = [
  ...
  { nameEn: "Clay lamps (Matti depalu)", nameTe: "మట్టి దీపాలు", quantity: 2 },
  { nameEn: "Sugar crystals", nameTe: "పంచదార బిళ్లలు", quantity: 1, packEn: "150g", packTe: "150 గ్రా" },
  { nameEn: "Coconuts", nameTe: "కొబ్బరికాయలు", quantity: 1 },
...
const ganeshMiniMandapamItems: SamagriItem[] = [
  ...
  { nameEn: "Clay lamps (Matti depalu)", nameTe: "మట్టి దీపాలు", quantity: 4 },
...
const ganeshMegaHomeItems: SamagriItem[] = [
  ...
  { nameEn: "Pooja vidhanam book", nameTe: "పూజా విధానం పుస్తకం", quantity: 1 },
  { nameEn: "Betel leaves", nameTe: "తమలపాకులు", quantity: 20 },
];
...
const ganeshMegaOfficeItems: SamagriItem[] = [
  ...
  { nameEn: "Pooja vidhanam book", nameTe: "పూజా విధానం పుస్తకం", quantity: 1 },
  { nameEn: "Betel leaves", nameTe: "తమలపాకులు", quantity: 25 },
];
...
const ganeshMegaMandapamItems: SamagriItem[] = [
  ...
  { nameEn: "Ghee", nameTe: "నెయ్యి", quantity: 1, packEn: "500g", packTe: "500 గ్రా" },
  ...
  { nameEn: "Betel leaves", nameTe: "తమలపాకులు", quantity: 30 },
];
...
const optionalOfferingItems: SamagriItem[] = [
  ...
  { nameEn: 'Ragi Chembu (Copper pot)', nameTe: 'రాగి చెంబు', quantity: 1, optional: true },
  { nameEn: 'Dhoti 9×5', nameTe: 'ధోతి 9×5', quantity: 1, packEn: '9×5', packTe: '9×5', optional: true },
  { nameEn: 'Panchamritam pack', nameTe: 'పంచామృతం ప్యాక్', quantity: 1, optional: true },
  { nameEn: 'Loose flowers', nameTe: 'విడిపూలు / పువ్వులు', quantity: 1, optional: true },
];

const optionalOfferingAliases: Record<string, string[]> = {
  'Ragi Chembu (Copper pot)': ['Copper pot (Chembu)', 'Copper pot (Ragi chembu)'],
  'Dhoti 9×5': ['Dhoti'],
};
...
function withOptionalOfferings(items: SamagriItem[]): SamagriItem[] {
  ...
  return [
    ...items,
    ...optionalOfferingItems.filter((extra) => {
      if (names.has(extra.nameEn)) return false;
      return !(optionalOfferingAliases[extra.nameEn] ?? []).some((name) => names.has(name));
    }),
  ];
}
...
const nameAliases: Record<string, string> = {
  ...
  'Clay lamps (Matti depalu)': 'Small diyas / wicks',
  'Copper pot (Ragi chembu)': 'Copper pot (Chembu)',
  'Ragi Chembu (Copper pot)': 'Copper pot (Chembu)',
  'Dhoti 9×5': 'Dhoti',
  'Dhoti 9X5': 'Dhoti',
