...
async function seedPriests() {
  const priests = [
    ...
    {
      slug: 'pandit-venkatesh-reddy',
      fullName: 'Pandit Venkatesh Reddy',
      bio: 'Temple pujari performing live online archana on video for devotees who cannot visit on their special days.',
      city: 'Hyderabad',
      state: 'Telangana',
      languages: ['Telugu', 'English', 'Hindi'],
      specializations: ['Online Archana', 'Satyanarayan', 'Temple Puja'],
      yearsExperience: 16,
      ratingAvg: 4.9,
      ratingCount: 142,
      ...
      archanaDeities: ['vishnu', 'any'],
    },
    {
      slug: 'pandit-ganesh-temple',
      fullName: 'Pandit Ganesh Bhatt',
      bio: 'Dodda Ganapathi temple pujari — Ganesha archana via scheduled video call with sankalpam in your name.',
      city: 'Bengaluru',
      state: 'Karnataka',
      languages: ['Kannada', 'English', 'Hindi'],
      specializations: ['Online Archana', 'Ganesha Puja', 'Festival Archana'],
      yearsExperience: 14,
      ratingAvg: 4.85,
      ratingCount: 118,
      ...
      sortOrder: 5,
      offersOnlineArchana: true,
      templeName: 'Dodda Ganapathi Temple',
      archanaDeities: ['ganesha'],
    },
    {
      slug: 'pandit-lakshmi-devi',
      fullName: 'Pandita Lakshmi Devi',
      bio: 'Friday Devi archana from a heritage temple — ideal when you cannot visit on vrata or festival days.',
      city: 'Bengaluru',
      state: 'Karnataka',
      languages: ['Kannada', 'Telugu', 'English'],
      specializations: ['Online Archana', 'Lakshmi Puja', 'Navaratri'],
      yearsExperience: 11,
      ratingAvg: 4.8,
      ratingCount: 89,
      ...
      archanaDeities: ['lakshmi', 'durga', 'any'],
    },
  ];
  ...
  for (const p of priests) {
    const priest = await prisma.priest.upsert({
      ...
      update: {
        ...
        offersOnlineArchana: p.offersOnlineArchana ?? false,
        templeName: p.templeName ?? null,
        archanaDeities: p.archanaDeities ?? [],
        isActive: true,
