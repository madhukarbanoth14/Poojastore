...
const CAMPAIGNS: Record<string, FestivalCampaignConfig> = {
  ganesh: {
    ...
    supporting: {
      en: "Eco-friendly Mini and Mega kits for home, office, and mandapam — each with a clay Ganesh idol, no POP.",
      te: "ఇల్లు, ఆఫీస్, మండపానికి మినీ మరియు మెగా పర్యావరణ అనుకూల కిట్‌లు — ప్రతిదానిలో మట్టి గణేష్ విగ్రహం, POP కాదు.",
    },
    heroShopCta: { en: "Shop Mini Home Kit", te: "మినీ ఇంటి పూజ కిట్" },
