...
const poojaGuides = <PoojaGuide>[
  PoojaGuide(id: 'ganapati', kind: PoojaKind.deity, titleEn: 'Ganapati / Vinayaka Chavithi', titleTe: 'గణపతి పూజ / వినాయక చవితి', kitSlug: 'ganesh-chaturthi-pooja-samagri', deityKitSlug: 'ganapati-special-samagri', special: [PoojaItem('Ganapati vigraham (clay for Chavithi)', 'గణపతి విగ్రహం / మట్టి గణపతి'), PoojaItem('21 kinds of patri', '21 రకాల పత్రి'), PoojaItem('Durva grass', 'దూర్వా గడ్డి'), PoojaItem('Red flowers', 'ఎర్రని పూలు'), PoojaItem('Modak / undrallu / kudumulu', 'మోదకం / ఉండ్రాళ్లు / కుడుములు'), PoojaItem('Panchamritam', 'పంచామృతం')]),
